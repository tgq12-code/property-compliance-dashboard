-- Avoid PL/pgSQL output-column ambiguity in the obligation reminder upsert.
...
begin
  ...
  on conflict on constraint obligation_reminder_log_obligation_id_due_date_reminder_day_key do nothing;
